        ...
        <Card className="shadow-xl border-0 bg-primary text-primary-foreground">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>お問い合わせ・相談窓口</span>
            </CardTitle>
            <CardDescription className="text-primary-foreground/80">
              AIシステムに関するご質問やご相談について
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <h3 className="font-semibold">カスハラ対策窓口</h3>
                <p className="text-sm text-primary-foreground/90">
                  TEL: 03-XXXX-XXXX<br />
                  Email: cushara-support@company.com<br />
                  受付時間: 平日 9:00-17:00
                </p>
              </div>
              
              <div className="space-y-2">
                <h3 className="font-semibold">AI・システム関連</h3>
                <p className="text-sm text-primary-foreground/90">
                  TEL: 03-YYYY-YYYY<br />
                  Email: ai-system@company.com<br />
                  受付時間: 平日 10:00-16:00
                </p>
              </div>
            </div>
